...
import com.example.fruitties.viewmodel.PhotoEnhancerViewModel
...
class AppContainer(
    ...
    val dataRepository: DataRepository by lazy {
        DataRepository(
            ...
            enhanceApi = factory.createEnhancerApi(),
            bgRemoveApi = factory.createBgRemoverApi(),
    ...
    val photoEnhancerVMFactory = viewModelFactory {
        initializer {
            PhotoEnhancerViewModel(repository = dataRepository)
        }
    }
