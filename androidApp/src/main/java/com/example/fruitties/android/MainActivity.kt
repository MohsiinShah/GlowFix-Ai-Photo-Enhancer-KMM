...
import com.example.fruitties.android.ui.SplashScreen
import kotlinx.serialization.Serializable

@Serializable
data object SplashScreenKey : NavKey
@Serializable
data object DashboardScreenKey : NavKey
    ...
    NavDisplay(
        ...
        entryProvider = entryProvider {
            entry<SplashScreenKey>{
                SplashScreen(moveToDashboard = {
                    backStack.add(DashboardScreenKey)
                })
            }

            entry<DashboardScreenKey> {
                ListScreen(
                    onFruittieClick = {
